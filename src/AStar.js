...
*/
AStarPathFinder = function (start, goal, depthConstraint, /*INeighborProviderFactory<T>*/ neighborProviderFactory, /*IHeuristicProvider<T>*/ hProvider) {
...
*/
AStarPathFinder.prototype.execute = function() {
	var current;
...
*/
AStarPathFinder.prototype._getPath = function(node) {
